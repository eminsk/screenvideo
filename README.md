...
- 🔊 **Запись системного звука (динамики / наушники)**: кристально чистый захват того, что вы слышите в наушниках и колонках (Windows WASAPI Loopback).
- 🎤 **Запись звука с микрофона**: возможность записи голоса или одновременного микширования звука системы и микрофона.
...
- ⏸️ **Пауза и Возобновление (Pause & Resume)**: мгновенная синхронная пауза видео и звука с сохранением плавности видеоряда.
...
- ⚙️ **Гибкие настройки**: выбор FPS (15, 24, 30, 60), аудиобитрейта (128k, 192k, 256k, 320k), видеокодека (mp4v, avc1, XVID), формата (MP4, AVI, MKV), папок сохранения и кастомных горячих клавиш.
